...
RUN apk add --no-cache apache2 && rm -rf /var/www/localhost/htdocs && ln -s -f /aaps/ /var/www/localhost/htdocs #&& sed -i 's/Listen 80/Listen 8080/g' /etc/apache2/httpd.conf
